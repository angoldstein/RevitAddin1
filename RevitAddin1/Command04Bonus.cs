...
namespace RevitAddin1
{
    ...
    public class Command04Bonus : IExternalCommand
    {
          ...
          ElementSet elements)
        {
            ...
            FrmCommand04Bonus curForm = new FrmCommand04Bonus(wallTypes, lineStyles);
            curForm.Height = 450;
            curForm.Width = 550;
            ...
            if(curForm.ShowDialog() == System.Windows.Forms.DialogResult.OK)
            {
                ...
                bool isStructrual = curForm.AreWallsStructural();
